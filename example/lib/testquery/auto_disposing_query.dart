...
class _AutoDisposingQueryState<
...
>
  ...
  void initState() {
    ...
    _query = _client.useQuery<TData, TQueryFnData>(
      ...
      widget.queryFn,
      options:
          widget.options?.copyWith(transformer: widget.transformer) ??
...
extension QueryOptionsExtension<
  TData extends Object?,
  TQueryFnData extends Object?
>
    on QueryOptions<TData, TQueryFnData> {
...
class QueryWatch<TData extends Object?, TQueryFnData extends Object?>
  ...
  Widget build(BuildContext context) {
    ...
    final query = client.useQuery<TData, TQueryFnData>(
      ...
      queryFn,
      options:
          options?.copyWith(transformer: transformer) ??
